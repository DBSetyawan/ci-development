			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('admin/home/tambahtransaksi', ['class' => 'form-horizontal', 'method' => 'post']); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="tanggal" value="<?php echo set_value('tanggal'); ?>">
